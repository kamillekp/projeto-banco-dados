...
input1 = tk.Entry(root, width=55, bg=cor_botoes_inputs, highlightbackground=cor_setas_bordas, highlightthickness=0.2).place(x=300, y=145)
input2 = tk.Entry(root, width=55, bg=cor_botoes_inputs, highlightbackground=cor_setas_bordas, highlightthickness=0.2).place(x=300, y=185)
